...
=======
	    sentences = [ sen + word + " " for sen in sentences]
	    #print sentences
	    word_count += 1
	    for i,seq_len in enumerate(buckets):
		    if word_count % seq_len == 0:
			    sen_id = self.text2id(sentences[i], vocab)
			    self.data[i].append(sen_id)
			    sentences[i] = ""
...
#            # we just ignore the sentence it is longer than the maximum
#            # bucket size here
>>>>>>> b05030db890e1ed841fb318898e0d5892f69caaf
